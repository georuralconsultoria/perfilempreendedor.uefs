...
function prepareHeader(sheet) {
  // Atualiza o cabeçalho mesmo quando a planilha já contém respostas.
  // Os novos campos foram adicionados no final para preservar as linhas antigas.
